            ...
            <motion.p initial={{opacity: 0, filter: "blur(20px)"}} animate={{opacity: 1, filter: "blur(0px)"}} transition={{delay: 0.6, duration: 1.4, ease: "easeInOut"}} className={`w-full select-none text-center text-white font-Red-Hat-Display px-5 md:px-10 xl:px-20 text-sm md:text-lg lg:text-sm xl:text-lg`}>Full Stack Web Developer with 2+ years of hands on experience in building scalable web apps. </motion.p>
             ...
             <div className={`w-full h-auto flex justify-center items-center`}>
               <Marquee speed={70} >
                ...
                return <motion.span initial={{opacity: 0, filter: "blur(20px)"}} animate={{opacity: 1, filter: "blur(0px)"}} transition={{delay: 0.6, duration: 1.4, ease: "easeInOut"}} key={index} className={`text-white text-4xl xl:text-6xl font-Hatton-Medium flex`}>{item} <SiGooglegemini className="mx-5" /></motion.span>
                 })}
               </Marquee>
             </div>

             <div className={`w-full flex justify-center items-center`}>
               <motion.p initial={{filter: "blur(20px)", opacity: 0}} animate={{opacity: 1, filter: "blur(0px)"}} transition={{delay: 0.6, duration: 1.4, ease: "easeInOut"}} className={`w-auto text-[10px] md:text-sm select-none rounded-full bg-white/20 backdrop-blur-sm text-white font-Red-Hat-Display font-semibold px-4 py-1`}>Blending tech & creativity</motion.p>
             </div>
          </div>
        </div>
